 ...
 * <p>
 * La classe CarteJoker représente l'ensemble des cartes 10 présentes au cours du jeu.
 * Une carte Joker est une carte spéciale, elle est caractérisée par :
 * <ul>
 * <li>Sa couleur</li>
 * <li>Sa hauteur</li>
...
public class CarteJoker extends Carte implements Serializable{
	...
	/**
	 * Redéfinition de l'effet d'une carte pour la carte Joker.
